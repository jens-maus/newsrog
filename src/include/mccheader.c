	...
	if (MUIMasterBase = OpenLibrary("muimaster.library",MASTERVERSION))
	{
		...
		#endif
		{
			...
			#endif
			{
				...
				UtilityBase   = (void *)THISCLASS->mcc_UtilityBase;
				DOSBase       = (void *)THISCLASS->mcc_DOSBase;
				GfxBase       = (void *)THISCLASS->mcc_GfxBase;
				IntuitionBase = (void *)THISCLASS->mcc_IntuitionBase;
